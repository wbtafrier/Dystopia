...
//	 */
//	EntityMob(String name, int health, BufferedImage img, int strength, int sight) {
...
//	 */
//	EntityMob(String name, int health, BufferedImage img, int strength, int sight, boolean tameable, boolean breedable) {
//		super(name, health, img);
//		this.strength = strength;
//		this.viewDistance = sight;
