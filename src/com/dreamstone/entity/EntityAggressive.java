...
//	 */
//	EntityAggressive(String name, int health, BufferedImage img, int strength, int sight) {
...
//	 */
//	EntityAggressive(String name, int health, BufferedImage img, int strength, int sight, boolean tameable, boolean breedable) {
//		super(name, health, img, strength, sight, tameable, breedable);
//	}
//}
