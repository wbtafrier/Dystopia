...
public abstract class EntityPassive extends EntityMob {
	 ...
	 */
	EntityPassive(String name, int health, String imgName, float speed, int strength, int sight) {
	 ...
	 */
	EntityPassive(String name, int health, String imgName, float speed, int stength, int sight, boolean tameable, boolean breedable) {
